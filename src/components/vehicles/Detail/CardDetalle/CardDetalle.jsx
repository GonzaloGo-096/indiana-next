...
export const CardDetalle = memo(({ auto, contactInfo }) => {
  ...
  // Un auto vendido no puede ofrecer "contactar por este auto": la consulta se
  // reorienta a unidades similares, que es el unico lead honesto que queda.
  const vendido = useMemo(() => isVendido(auto), [auto]);
  ...
  const nombreVehiculo = `${vehicleData.marca} ${vehicleData.modelo} ${vehicleData.version || ""}`.trim();

  const mensajeWhatsapp = vendido
    ? `Hola! Vi que el ${nombreVehiculo} figura como vendido. ¿Tenés unidades similares?`
    : `Hola! Me interesa el ${nombreVehiculo} - ${offer.hasOffer ? offer.priceOffer : formatPrice(vehicleData.precio)}`;
      ...
      <div className={styles.mainLayout}>
        ...
        <div className={styles.dataSection}>
          ...
          <div className={styles.priceColumn}>
            <div className={`${styles.priceSection} ${vendido ? styles.priceSection_vendido : ""}`}>
              <VehiclePrice
                styles={styles}
                offer={offer}
            ...
            <div className={styles.whatsappSection}>
              <WhatsAppLink
                ...
                aria-label={
                  vendido
                    ? "Consultar por unidades similares"
              ...
              >
                ...
                <span>
                  {vendido ? "Consultar unidades similares" : "Contactar por WhatsApp"}
                </span>
              </WhatsAppLink>
            </div>
          </div>
