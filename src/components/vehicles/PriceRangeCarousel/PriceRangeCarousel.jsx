 ...
 * 
 * Muestra vehículos con precio similar (±1 millón) en un carrusel horizontal.
...
export const PriceRangeCarousel = ({ currentVehicle }) => {
  const { vehicles, priceRange, isLoading, isError } =
    usePriceRangeVehicles(currentVehicle);
